...
public class OnboardingController {
    ...
    @Operation(summary = "온보딩(회원가입) 하지 않은 유저의 테스트 캐릭터 발급 API", description = "온보딩 결과를 통해, 온보딩 캐릭터와 기업 규모, 복지 데이터를 제공하는 API입니다.")
    ...
    @Operation(summary = "온보딩(회원가입)한 유저의 테스트 캐릭터 발급 API", description = "온보딩한 유저의 테스트 결과를 제공하는 API입니다.")
    ...
    @Operation(summary = "테스트 이후 온보딩(회원가입) API", description = "테스트 이후, 유저의 회원가입을 하는 API입니다.")
    ...
    @Operation(summary = "테스트 없이 온보딩(회원가입) API", description = "테스트 없이, 유저의 회원가입을 하는 API입니다.")
    @PostMapping("/signup")
